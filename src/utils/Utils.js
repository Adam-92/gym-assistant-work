...
export const positionCharacters = (character1, character2, character3, index) =>{
    ...
    if(index === 0) {
      character1.style.transform = `translate(194%, -57%) scale(0.8)`
